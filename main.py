...
# Config 
class Config(object):
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7025718764:AAHdkRP-1pq9oPbOozRthYAHHAlOm2AbBHs")
    API_ID = int(os.environ.get("API_ID", "28858012"))
    API_HASH = os.environ.get("API_HASH", "56945f03a1655e86d2acd263db20a1fc")
